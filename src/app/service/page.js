...
const services = [
  ...
  },
  {
    ...
    desc: "Optimize your resume with our AI-powered ATS scanner to ensure you pass automated screening and land your dream job.",
  },
  {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mt-8">
                      <Link
                        href={service.link}
                        className="px-5 py-3 rounded-2xl bg-zinc-800 hover:bg-violet-600 transition-all duration-300 text-white text-sm"
                      >
                        Get Started
                      </Link>
                    </div>
