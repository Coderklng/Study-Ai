        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
          ...
          <div className="relative flex justify-center items-center w-full">
            ...
            <div className="hidden md:block absolute top-[40%] right-70">
              <div className="bg-zinc-950/90 border border-zinc-800 backdrop-blur-md p-5 rounded-2xl text-white shadow-xl">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-zinc-400">Smart study notes</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="bg-zinc-950/90 border border-zinc-800 backdrop-blur-md p-5 rounded-2xl text-white shadow-xl">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-zinc-400">Generate quizzes instantly</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="bg-zinc-950/90 border border-zinc-800 backdrop-blur-md p-5 rounded-2xl text-white shadow-xl">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-zinc-400">Instant AI answers</p>
                  </div>
                </div>
              </div>
            </div>
